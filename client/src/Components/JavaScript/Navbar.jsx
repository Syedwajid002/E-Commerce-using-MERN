  ...
  return (
    <div className="md:flex justify-center md:justify-between bg-[#F3F2F4] pt-2">
      <div className="flex justify-between">
        <a
          className="ml-2 mt-2 md:mt-0 text-orange-500 "
          data-aos="zoom-out"
          href="/"
        >
          <strong>
            <span className="text-sky-400 mr-1 text-2xl text-center">
              Online
            </span>
        ...
        {auth ? (
          <div className="flex gap-1 md:hidden">
            <p className="p-1.5 mb-2 mt-2 mr-2"> {name}!</p>
            <button
          ...
          <Link to="/login">
            <button className="bg-blue-600 text-white p-1.5 mb-2 mt-2 mr-2 rounded-lg md:hidden">
              Login
            </button>
          </Link>
        )}
      ...
      <div className="flex justify-center">
        ...
        >
          <input
            className="border-1 rounded-xl pl-1 pr-1 mr-2"
            type="search"
          ...
          />
          <button
            className="bg-black hover:bg-green-600 text-white rounded-lg p-1.5 "
            type="submit"
          >
            Search
          </button>
      ...
      {auth ? (
        <div className="hidden justify-center md:flex">
          ...
          >
            <img
              className="w-8 h-8 object-contain hover:border-b-2 hover:border-black p-0.5 mr-2"
              src={cartImage}
              alt=""
            />
          </div>
